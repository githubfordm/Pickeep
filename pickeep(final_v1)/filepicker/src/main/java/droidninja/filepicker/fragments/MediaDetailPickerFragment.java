...
public class MediaDetailPickerFragment extends BaseFragment{
    ...
    private void updateList(List<PhotoDirectory> dirs) {
        ...
        if(medias.size()>0) {
            ...
            {
                photoGridAdapter = new PhotoGridAdapter(getActivity(), mGlideRequestManager, (ArrayList<Media>) medias, PickerManager.getInstance().getSelectedPhotos(),(fileType==FilePickerConst.MEDIA_TYPE_IMAGE));
