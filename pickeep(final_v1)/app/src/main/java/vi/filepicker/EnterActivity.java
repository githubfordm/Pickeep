...
//        startActivity(intent);
    ...
    private void init()
    {
        ...
        BitmapDrawable drawable = (BitmapDrawable)getResources().getDrawable(R.drawable.book_2);
        photo = drawable.getBitmap();
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        layout = inflater.inflate(R.layout.popup_activity, (ViewGroup)findViewById(R.id.popup));
                ...
                if(bookCount <= 14) {
                    if (bookName.getText().toString().length() == 0) // 책 제목을 넣지 않았다면,
                        ...
                        if (!new_folder.exists()) {
                            new_folder.mkdir();
                            Log.i("ggg", "new folder ? = " + new_folder.exists());
                            if (photo != null) {
...
//                        Toast.makeText(getApplicationContext(), "추가할 책의 인덱스 : " + bookCount + "", Toast.LENGTH_SHORT).show();
    ...
    private void storeCropImage(Bitmap bitmap, String filePath) {
        ...
        Log.i("ggg","copyFile in storeCropImge = "+copyFile.getPath());
        //비트맵 형식으로 파일을 만든다.
        try {
    ...
    public void showContents(View view) {
        ...
        if(bookPath[index] != null){
            ...
            Log.i("pppp","EnterActivity dir path = "+bookPath[index]+"/");}
        startActivity(intent);
    }
    ...
    private void setList() {
        ...
        if(size != 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Bitmap src = BitmapFactory.decodeFile(list[i].getPath() + "/" + title + ".png");
...
//            Toast.makeText(getApplicationContext(), "다시 로딩후  : " + bookCount + "", Toast.LENGTH_SHORT).show();
    ...
    private void scanning(int bookCount, String folderPath) {
        ...
        if(bookArray[bookCount] != null)
            button_list[bookCount].setImageBitmap(bookArray[bookCount]);
...
//            Toast.makeText(getApplicationContext(),"책의 수 : " + bookCount+"",Toast.LENGTH_SHORT).show();
    ...
    public void popup_delete(View v)
    {
        ...
        delete_window.setWidth(delete_window.getWidth());
        delete_window.setHeight(delete_window.getHeight());
