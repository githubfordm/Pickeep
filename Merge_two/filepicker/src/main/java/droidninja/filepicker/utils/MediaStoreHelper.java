...
import droidninja.filepicker.cursors.PickerScannerTask;
...
public class MediaStoreHelper {
  ...
  public static void getList(FragmentActivity activity, FileResultCallback<Document> fileResultCallback)
  {
    new PickerScannerTask(activity,fileResultCallback).execute();
  }
}