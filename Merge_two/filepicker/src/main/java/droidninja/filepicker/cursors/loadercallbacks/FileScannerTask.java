...
public class FileScannerTask extends AsyncTask<Void,Void,List<Document>> {
    ...
    public FileScannerTask(Context context, FileResultCallback<Document> fileResultCallback, String dir_path)
    {
    ...
    protected List<Document> doInBackground(Void... voids) {
        ...
        String selection = MediaStore.Files.FileColumns.MEDIA_TYPE + "="
                + MediaStore.Files.FileColumns.MEDIA_TYPE_NONE+ " and "+MediaStore.Files.FileColumns.DATA+" like ? ";  // 이미지,비디오같은 파일을 제외한 파일만 select하겠다는 으의지
